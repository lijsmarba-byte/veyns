...
export function ProfileSignatureContentV2({ user }: { user: MockUserProfile }) {
  ...
  return (
    <div className="mx-auto w-full max-w-none border border-line bg-paper px-10 pb-8 pt-0 shadow-[0_1px_2px_rgba(0,0,0,0.05)] md:px-10 md:pb-10 md:pt-0">
          ...
          >
            ...
            <AnimatePresence>
              {activeCluster ? (
                ...
                >
                  <div className="pointer-events-auto relative w-full max-w-[600px] max-h-[78%] overflow-y-auto rounded-[2px] border border-line bg-paper p-8">
                    <button
                      type="button"
                    ...
                    <p className="mt-4 text-justify font-ui text-[14px] font-normal leading-[1.7] text-meta">
                      {thesisText}
                    </p>
