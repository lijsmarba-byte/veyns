    ...
    <div data-pv-info-hit="true" className="relative flex items-center gap-[10px]">
      ...
      {mode === "archive" ? (
        ...
        <div ref={dropdownRef} className="relative">
          ...
          {isDropdownVisible ? (
            <div
              className={`absolute left-0 top-[39px] z-20 min-w-full rounded-[14px] border border-line bg-paper p-[6px] shadow-[0_8px_20px_rgba(17,17,17,0.14)] transition-all duration-[180ms] ease-out ${
                isDropdownOpen
